...
문자열을 대상으로한 패턴 매칭 기능을 제공하므로, 예를 들어 회원 가입 시 필요한 사용자가 입력한 비밀번호의 패턴 확인, 전화번호 유효성 확인 등의 기능에서 활용할 수 있다. 
*/
...
// 정규 표현식 리터럴 : /패턴/플래그
let regexp = /j/i; // 패턴 : j, 플래그 : i => 대소문자 구분하지않음
...
// test 메소드 - target 문자열에 대해 정규 표현식 regexp의 패턴을 검색하여 매칭 결과를 Boolean으로 반환
